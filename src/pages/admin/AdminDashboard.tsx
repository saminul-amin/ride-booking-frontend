...
const AdminDashboard = () => {
  ...
  const { data: allRidesData, isLoading: ridesLoading } =
  ...
  const completedRides =
    allRides?.filter((ride: any) => ride.status === "completed")?.length || 0;
  const activeRides =
    allRides?.filter((ride: any) => ride.status === "in_progress")?.length || 0;
  const pendingRides =
    allRides?.filter((ride: any) => ride.status === "pending")?.length || 0;
          ...
          <div className="bg-card rounded-lg border p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-blue-600 mt-1">{todayRides} today</p>
              </div>
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          <p className="text-sm text-muted-foreground capitalize underline">
                            {ride.status || "pending"}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                          ...
                          <div>
                            ...
                            <div className="flex items-center space-x-4 mt-1">
                              <span className="text-xs text-muted-foreground">
                                {driver.stats?.totalRides || 0} rides
                              </span>
                            </div>
                          </div>
                        </div>
                        <div className="flex items-center space-x-2">
                          <button
                            ...
                            className="bg-red-400 hover:bg-red-600 text-white px-3 py-1 rounded text-sm cursor-pointer hover:underline"
                          >
                            Delete
                          </button>
                        </div>
                      ...
                      <div className="space-y-2 mb-3">
                        ...
                        <div className="flex items-start space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                              {ride.destinationLocation?.address || "Unknown"}
                            </p>
                          </div>
                        </div>
                      </div>
